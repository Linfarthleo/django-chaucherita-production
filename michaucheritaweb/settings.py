"""
Django settings for michaucheritaweb project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', default='django-insecure-#_z!'+os.urandom(24).hex())
...
WSGI_APPLICATION = 'michaucheritaweb.wsgi.application'
